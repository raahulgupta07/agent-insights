<template>
    ...
    <div v-if="accessError" class="h-dvh w-screen flex items-center justify-center bg-gray-50">
    ...
    <div v-else class="h-dvh w-screen relative bg-gray-50 flex flex-col overflow-hidden">
        <!-- Top Bar -->
