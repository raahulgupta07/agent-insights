      ...
      <div class="mb-5">
        <div class="flex items-start gap-3">
          <div class="min-w-0 flex-1">
            ...
            <!-- Tags -->
            <div v-if="detail?.tags?.length" class="mt-2 flex items-center gap-1.5 flex-wrap">
              <span
          ...
          <div class="flex-shrink-0 ms-auto flex items-center gap-2">
            <button v-if="canDeleteEntities" class="text-[11px] px-2.5 py-1 rounded-lg border border-[#e6cfcd] bg-[#f7eeed] text-[#b4504a] hover:bg-[#f1e2e0] transition-colors" @click="deleteEntity" :disabled="deleting">
        ...
        <div class="mt-3 flex items-center gap-2 flex-wrap">
          ...
          <button v-if="canApprove" class="ms-auto text-[11px] px-2.5 py-1 rounded-lg border border-[#cde7d6] bg-[#eef6f0] text-[#3f9e6a] hover:bg-[#e3f0e8] transition-colors" @click="approveSuggestion" :disabled="approving">
            <span v-if="approving">{{ $t('queries.detail.approvingInProgress') }}</span>
            <span v-else>{{ $t('queries.detail.approveAction') }}</span>
          </button>

          <button v-if="canApprove" class="text-[11px] px-2.5 py-1 rounded-lg border border-[#e6cfcd] bg-[#f7eeed] text-[#b4504a] hover:bg-[#f1e2e0] transition-colors" @click="rejectSuggestion" :disabled="rejecting">
          ...
          <div class="border border-[#E9E0D3] rounded-2xl bg-white overflow-hidden">
            ...
            <div class="flex border-b border-[#E9E0D3] px-1">
              ...
              >
                ...
                <span v-if="rowCount" class="ms-1.5 text-[11px] text-[#9a958c]">({{ rowCount }})</span>
              </button>
              <button
