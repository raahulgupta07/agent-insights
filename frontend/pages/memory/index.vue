                ...
                <div v-else class="flex flex-col gap-3">
                    ...
                    >
                        ...
                        <div class="flex flex-wrap items-center gap-2 text-[11px] text-[#9a958c]">
                            <span
                                class="inline-flex items-center rounded-full border border-[#E9E0D3] bg-[#F4EEE5] px-2 py-0.5 font-medium text-[#6b6b6b]"
                        ...
                        <div v-if="activeTab === 'pending'" class="pt-3 border-t border-[#E9E0D3] flex items-center gap-2">
                            ...
                            <button
                                type="button"
                                class="inline-flex items-center gap-1.5 rounded-xl border border-[#E9E0D3] bg-white px-3 py-1.5 font-medium text-[#1f2328] transition hover:bg-[#FBEFE4] disabled:opacity-50 disabled:cursor-not-allowed"
                                :disabled="acting[mem.id]"
                                @click="reject(mem)"
                            >
                                <Icon
                                    :name="acting[mem.id] === 'reject' ? 'heroicons:arrow-path' : 'heroicons:x-mark'"
                                    class="w-4 h-4 text-[#A8330F]"
