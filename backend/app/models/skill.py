...
class Skill(BaseSchema):
    ...
    # Provenance: 'manual' (hand-authored) vs 'auto' (👍 auto-proposed via feedback).
    origin = Column(String(20), nullable=True, server_default="manual")

    # --- bi-temporal (HYBRID_BITEMPORAL / skill optimizer) ---
