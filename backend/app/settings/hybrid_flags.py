...
UPGRADE_FLAGS: dict[str, dict[str, str]] = {
    ...
    "HYBRID_AUTOTRAIN_ON_INDEX": {"label": "Autotrain on Connector Index", "role": "agent", "category": "Ingest", "status": "risky", "note": "RISK — leave OFF. Auto-trains every new table — costly/slow on big warehouses. Env-only knob."},
