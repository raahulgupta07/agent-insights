...
# Re-parented from "sessumm1" to the current true head so this doesn't fork the
# Alembic history into two heads (ingest-brain branch was cut from an older base).
down_revision: Union[str, None] = "connsyncrun1"
