                        ...
                        <div class="px-6 py-4 border-b border-[#E7E5DD]">
                            <div class="flex flex-col md:flex-row md:items-center gap-3">
                                ...
                                <div class="flex items-center gap-2 w-full md:w-auto">
                                    ...
                                    <!-- Actions -->
                                    <UButton :disabled="selectedIds.size === 0" color="orange" size="xs" icon="i-heroicons-play" @click="runSelected">{{ $t('evals.tests.runSelected') }}</UButton>
                                    <UButton color="orange" size="xs" variant="soft" icon="i-heroicons-plus" @click="addNewTest">{{ $t('evals.tests.addNew') }}</UButton>
                                </div>
                            </div>
                        </div>
                                ...
                                <tbody class="bg-white divide-y divide-[#E7E5DD] text-xs">
                                    <tr v-for="c in filteredTests" :key="c.id" class="hover:bg-[#faf8f3]">
                                        ...
                                        <td class="px-6 py-3">
                                            <div class="flex items-center gap-2">
                                                ...
                                                <UButton color="orange" size="xs" variant="soft" icon="i-heroicons-play" @click="runCase(c)">{{ $t('evals.tests.actionRunTest') }}</UButton>
                                    ...
                                    <tr v-if="filteredTests.length === 0">
                                        <td colspan="5" class="px-6 py-10 text-center">
                                            ...
                                            <h3 class="text-[15px] font-semibold text-[#1f2328]" style="font-family: ui-serif, Georgia, 'Times New Roman', serif">{{ $t('evals.tests.empty') }}</h3>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                ...
                                <tbody class="bg-white divide-y divide-[#E7E5DD] text-xs">
                                    ...
                                    <tr v-if="filteredRuns.length === 0">
                                        <td colspan="7" class="px-6 py-10 text-center">
                                            ...
                                            <h3 class="text-[15px] font-semibold text-[#1f2328]" style="font-family: ui-serif, Georgia, 'Times New Roman', serif">{{ $t('evals.runs.empty') }}</h3>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
