    ...
    <div class="w-full max-w-7xl px-4 ps-0 py-2 text-[#1f2328]">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <div
          ...
          :key="item.id"
          class="bg-white border border-[#E7E5DD] rounded-2xl p-4 hover:shadow-lg hover:-translate-y-0.5 hover:border-[#d9d6cd] transition-all cursor-pointer flex flex-col"
