    ...
    <template v-if="collapsed">
      <div class="flex flex-col items-center gap-1 py-2">
        <button
          ...
          class="flex items-center justify-center w-8 h-8 rounded-md text-[#A8542F] border border-[#E7E5DD] bg-white hover:bg-[#F3E7DF] hover:border-[#C2683F] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          title="New chat"
        >
    ...
    <template v-else>
      ...
      <div class="px-2.5 pt-2.5 pb-1.5 flex items-center gap-2">
        <button
          @click="createNewReport"
          :disabled="creatingReport"
          class="flex-1 flex items-center justify-center gap-2 px-3 py-1.5 rounded-md text-[13px] font-semibold border border-[#E7E5DD] bg-white text-[#A8542F] hover:bg-[#F3E7DF] hover:border-[#C2683F] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
        >
