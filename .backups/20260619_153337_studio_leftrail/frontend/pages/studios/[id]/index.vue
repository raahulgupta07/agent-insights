...
const tabs = computed(() => [
    ...
    { value: 'connection', label: t('studio.tabConnection') || 'Connection', icon: 'i-heroicons-link' },
    { value: 'tables', label: t('studio.tabTables') || 'Tables', icon: 'i-heroicons-table-cells' },
    { value: 'tools', label: t('studio.tabTools') || 'Tools', icon: 'i-heroicons-wrench-screwdriver' },
    ...
    { value: 'queries', label: t('studio.tabQueries') || 'Queries', icon: 'i-heroicons-code-bracket-square' },
    { value: 'skills', label: t('studio.tabSkills'), icon: 'i-heroicons-sparkles' },
    { value: 'evals', label: t('studio.tabEvals') || 'Evals', icon: 'i-heroicons-beaker' },
    { value: 'monitoring', label: t('studio.tabMonitoring') || 'Monitoring', icon: 'i-heroicons-chart-bar' },
