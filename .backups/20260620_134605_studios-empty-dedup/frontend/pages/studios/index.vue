        ...
        <div class="w-full max-w-7xl px-4 ps-0 py-2 h-full">
            ...
            <div class="flex items-start justify-between mb-6">
                ...
                <UButton
                    ...
                    class="bg-[#C2683F] hover:bg-[#A8542F] text-white font-semibold border-0 cursor-pointer"
                    @click="openCreate"
                >
                    {{ $t('studio.newStudio') }}
                </UButton>
                ...
                <section class="mb-8">
                    ...
                    <div v-if="ownStudios.length === 0">
                        <div class="py-14 px-6 text-center bg-white border border-[#E7E5DD] rounded-2xl">
                            ...
                            <UButton color="white" size="xs" icon="i-heroicons-plus" class="bg-[#C2683F] hover:bg-[#A8542F] text-white font-semibold border-0 cursor-pointer" @click="openCreate">
                                {{ $t('studio.newStudio') }}
                            </UButton>
                        </div>
                    </div>
                    ...
                    <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                        <StudioCard
                            ...
                            :key="s.id"
                            :studio="s"
                            class="transition hover:shadow-md hover:-translate-y-0.5 cursor-pointer"
                            @open="goto(s.id)"
                ...
                <div class="p-6">
                    ...
                    <div class="mt-6 flex items-center justify-end gap-2">
                        ...
                        <UButton
                            color="white"
                            size="sm"
                            class="bg-[#C2683F] hover:bg-[#A8542F] text-white font-semibold border-0 cursor-pointer disabled:opacity-50"
                            :loading="creating"
