    ...
    <div class="mt-6">
        ...
        <div v-if="!loading && !error" class="space-y-6">
            ...
            <div class="md:w-2/3 space-y-2">
                ...
                <UInput v-model="form.ai_analyst_name" :maxlength="50" placeholder="City Agent Analyst" />
            </div>
...
const error = ref('')
const general = ref<GeneralConfig>({ ai_analyst_name: 'City Agent Analyst', bow_credit: true })
const form = ref<{ organization_name?: string; locale: string } & GeneralConfig>({
    ai_analyst_name: 'City Agent Analyst',
    bow_credit: true,
    locale: '',
})
...
const fetchSettings = async () => {
    ...
    try {
        ...
        general.value = cfg?.general || { ai_analyst_name: 'City Agent Analyst', bow_credit: true }
