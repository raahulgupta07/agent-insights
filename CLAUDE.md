...
**Current state (2026-07-06, NEWEST — v1.130→1.138 BAKED into `cityagent-analytics:dev`):** `VERSION_HYBRID`=**1.138.0**. Org `b2bec83d` ("Main Org", ONLY org), admin `admin@cityagent.io`/`Admin12345`. Rollback images `pre-v1135`/`pre-v1136`/`pre-v1137`/`pre-v1138`. Session backups `backend/.backups/{1783318496_instrscope_automodel,1783321168_dbclients_keyfix}/` + `frontend/.backups/1783317133_uxpbi/` + `backend/.backups/*_hybridflags_autoartifact.py`.
