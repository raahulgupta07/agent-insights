...
**Current state (2026-07-07, NEWEST — v1.160.3 BAKED BE + recreated healthy):** `VERSION_HYBRID`=**1.160.3**, remote `agent-insights` `main` (v1.160.2 was `e57e5ed9`, v1.160.1 `24746e23`). Rollback imgs `pre-v1603`/`pre-v1602`/`pre-v1601`/`pre-v160`/`pre-v159`/`pre-v158`. Org `b2bec83d` ("Main Org", ONLY org), admin `admin@cityagent.io`/`Admin12345`.
