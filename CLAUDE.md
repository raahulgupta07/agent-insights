...
**Current state (2026-07-07, NEWEST — v1.160.2 BAKED BE + recreated, NOT yet pushed):** `VERSION_HYBRID`=**1.160.2**, branch `main` (last push `24746e23`=v1.160.1; v1.160.2 baked+recreated, git commit+push PENDING). Rollback imgs `pre-v1602`/`pre-v1601`/`pre-v160`/`pre-v159`/`pre-v158`/`pre-v157`. Org `b2bec83d` ("Main Org", ONLY org), admin `admin@cityagent.io`/`Admin12345`.
