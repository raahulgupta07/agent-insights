...
**Current state (2026-07-06, NEWEST — v1.144.0 BAKED + recreated into `cityagent-analytics:dev`, NOT git-committed):** `VERSION_HYBRID`=**1.144.0**. Rollback img `cityagent-analytics:pre-v144`.
