...
**Current state (2026-07-05, LATEST):** `VERSION_HYBRID`=**1.105.0**, **DURABLE-BAKED** into `cityagent-analytics:dev` (build.sh + force-recreate, verified code-in-image), **NOT git-committed**. Three ships this session, all baked together:
