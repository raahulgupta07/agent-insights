...
**Current state (2026-07-07, NEWEST — v1.160.1 BAKED FE+BE + recreated + PUSHED):** `VERSION_HYBRID`=**1.160.1**, branch `main` at `24746e23` on remote `agent-insights` (`git@github.com:raahulgupta07/agent-insights.git`, SSH). Rollback imgs `pre-v1601`/`pre-v160`/`pre-v159`/`pre-v158`/`pre-v157`. Org `b2bec83d` ("Main Org", ONLY org), admin `admin@cityagent.io`/`Admin12345`.
