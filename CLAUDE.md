...
**Current state (2026-07-04, LATEST):** UPSTREAM PORT **ALL 5 WAVES DONE (W0-W4)** + flag flips + F09 bake + STUDIO UX OVERHAUL. Branch `feature/table-relevance-overview`, **NOTHING pushed**. Mig head **single `sidesort1`**.
