...
**Current state (2026-07-06, LATEST):** `VERSION_HYBRID`=**1.129.0** on branch `integration/merge-all-20260705` (NEVER push straight to main). v1.126–1.129 = this session's ships, **hot-cp/fe-sync only, NOT git-committed, NOT baked**. Org `b2bec83d` ("Main Org", ONLY org), admin `admin@cityagent.io`/`Admin12345`.
