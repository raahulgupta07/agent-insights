...
**Current state (2026-07-05, LATEST):** `VERSION_HYBRID`=**1.113.0** on branch `integration/merge-all-20260705` (NEVER push straight to main). v1.108–1.113 = FE-sync/hot-cp + git-committed, **NOT pushed**. Org `b2bec83d` ("Main Org", ONLY org), admin `admin@cityagent.io`/`Admin12345`.
